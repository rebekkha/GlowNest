  ...
  return (
    ...
    >
      <div className="text-center mb-12">
        ...
        <p className="text-[#E5A9B4] tracking-[0.2em] uppercase text-xs font-semibold">Our flagship premium AI scan reveals your elite complexion</p>
      </div>

      <div className="relative aspect-video rounded-3xl overflow-hidden glass border-2 border-[#E5A9B4]/20 shadow-2xl shadow-[#E5A9B4]/20 max-w-2xl mx-auto">
        {!capturedImage ? (
          <Webcam
            audio={false}
            ref={webcamRef}
        ...
        <AnimatePresence>
          {isScanning && (
            ...
            >
              ...
              <div className="absolute inset-0 bg-[#E5A9B4]/10 backdrop-blur-[2px]" />
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  <div className="flex justify-center mb-4">
                    ...
                    >
                      <Zap className="w-12 h-12 text-[#E5A9B4] fill-[#E5A9B4]/30" />
                    </motion.div>
                  </div>
                  <p className="text-[#E5A9B4] font-display italic text-2xl tracking-wider">Analyzing Premium Signature...</p>
                </div>
              </div>
            </motion.div>
          )}
      ...
      <div className="mt-16 grid grid-cols-4 gap-8">
        {['VIP Analysis', 'Royal Care', 'Pure Precision', 'Eco-Luxury'].map((feature, i) => (
          <div key={i} className="text-center">
            ...
            <div className="h-[1px] w-full bg-gradient-to-r from-transparent via-[#E5A9B4]/30 to-transparent" />
          </div>
        ))}
      </div>
    </motion.div>
