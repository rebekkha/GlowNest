  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-10">
        <h2 className="text-4xl font-display font-bold text-[#E5A9B4] mb-2 italic">Welcome to GlowNext Premium</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="flex flex-col items-center mb-8">
          ...
          >
            ...
            <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity">
              <span className="text-[10px] uppercase font-bold text-[#E5A9B4]">Edit Photo</span>
            </div>
          </div>
          <input 
            type="file" 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-white/5 border border-white/10 rounded-xl py-3 pl-12 pr-4 focus:border-[#E5A9B4] outline-none transition-colors"
                value={profile.name}
          ...
          <div className="space-y-2">
            <label className="text-[10px] uppercase font-bold text-[#E5A9B4] ml-1">Age</label>
            <input
              required
              type="number"
              placeholder="Your age"
              className="w-full bg-white/5 border border-white/10 rounded-xl py-3 px-4 focus:border-[#E5A9B4] outline-none transition-colors"
              value={profile.age}
          ...
          <div className="space-y-2">
            <label className="text-[10px] uppercase font-bold text-[#E5A9B4] ml-1">Phone Number</label>
            <div className="relative">
          ...
          <div className="space-y-2">
            <label className="text-[10px] uppercase font-bold text-[#E5A9B4] ml-1">Pin Code</label>
            <input
              required
              type="text"
        ...
        <div className="space-y-2">
          <label className="text-[10px] uppercase font-bold text-[#E5A9B4] ml-1">Delivery Address</label>
          <div className="relative">
            <MapPin className="absolute left-4 top-4 w-4 h-4 text-[#E5A9B4]/50" />
            <textarea
              required
              placeholder="Your street address"
              className="w-full bg-white/5 border border-white/10 rounded-xl py-3 pl-12 pr-4 min-h-[100px] focus:border-[#E5A9B4] outline-none transition-colors"
        ...
        <AnimatePresence>
          {isOtpSent && (
            ...
            >
              <label className="text-[10px] uppercase font-bold text-[#E5A9B4] ml-1">Enter OTP (Sent to mobile)</label>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-xl py-3 pl-12 pr-4 focus:border-[#E5A9B4] outline-none transition-colors text-center tracking-[1em]"
                  value={otp}
